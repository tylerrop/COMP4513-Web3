<?php 
	...
	$title = 'Your Requests' . TITLEADDON; 

	function printUserPrograms()
	{
		$tableRows = "";
	    ...
	    $sqlStatement = "SELECT request.*, createprogramrequest.*, users.* 
	    				 ...
	    				 WHERE request.id = createprogramrequest.id AND request.userId = users.userID AND request.userId ='$currUser'
	...
	<div class="container roundCorners">
		<div class="jumbotron roundCorners medPadding">
			<h1 class="noPadding noMargins bold">Your Requests</h1>  
